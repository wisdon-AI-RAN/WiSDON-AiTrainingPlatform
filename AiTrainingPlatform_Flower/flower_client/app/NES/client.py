...
class Client(fl.client.NumPyClient):
    def __init__(
        ...
        # Initialize model
        self.model = DDPGAgent(state_dim=N_FEATS*10*TOTAL_BS, action_dim=ACTION_DIM, device=self.device)

    def set_parameters(self, parameters):
        # Load model's federated learning parameters with the server's given.            
        actor_net_parameter = parameters
    ...
    def fit(self, parameters, config):
        ...
        loss = self.model.train(train_dataset = self.trainset, 
