...
def train(msg: Message, context: Context):
    ...
    if context.run_config["mode"] == "retrain":
        # Load the data
        ...
        data_loader = DataLoader(app_name = context.run_config["app_name"],
                    ...
                    port = context.run_config["mongodb_port"])
